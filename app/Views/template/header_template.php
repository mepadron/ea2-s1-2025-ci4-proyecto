    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="/loginForm">Login</a></li>
                <li class="menu-item hidden"><a href="/avatar">Docs</a>
                </li>
                <li class="menu-item hidden"><a href="https://forum.codeigniter.com/">Community</a></li>
